...
public class Ex2SoftAssert extends TestBase {
    ...
    public void ex2SoftAssert() {
        ...
        //5. Check user name
        softAssertion.assertEquals(driver.findElement(By.cssSelector(".profile-photo")).getText(), "PITER CHAILOVSKII");
        ...
        softAssertion.assertEquals(imageColums.size(), 4);
        ...
        softAssertion.assertEquals(textColums.size(), 4);
        ...
        softAssertion.assertEquals(driver.findElement(By.cssSelector("h3.main-title")).getText(), "EPAM FRAMEWORK WISHES…");
        softAssertion.assertEquals(driver.findElement(By.cssSelector("p.main-txt.text-center")).getText(), "LOREM IPSUM DOLOR SIT AMET, CONSECTETUR ADIPISICING ELIT, SED DO EIUSMOD TEMPOR INCIDIDUNT UT LABORE " +
